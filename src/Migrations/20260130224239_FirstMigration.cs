        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Values__FileName",
                table: "Values_",
                column: "FileName");

            migrationBuilder.Sql(@"
                SELECT create_hypertable('public.""Values_""', 'Date', chunk_time_interval => INTERVAL '7 days');
            ");
        }
